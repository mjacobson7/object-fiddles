...
//Make a 'favoriteThings' object that contains the following keys: band, food, person, book, movie, holiday. Have the values to those keys
//be your favorite thing in that category.
...
//Create an Object called 'album' with 5 keys named different song titles that you make up, with the values being the length of each song.
  ...
  var album = {
    ...
    "Third song": "4:42",
    "Fourth Song": "1:56",
    "This is the last song": "4:24",
  };

//Now, loop through your album object alerting every song title individually.

  //Code Here
  for(var songNames in album) {
    alert(songNames);
  }
...
that each value is truthy. If it's not truthy, remove it from the object. */
  ...
  //Code Here
  for(var objCheck in user1) {
    if(!user1[objCheck]) {
      delete user1[objCheck];
    }
  }

//Once you get your truthy Object, Change the remaining values in the object to be specific to you (name: 'your name', username: 'your
// username'), rather than my information.

  //Code Here
  user1.name = "Max Jacobson";
  user1.username = "mjacobson7";
...
//information that you passed in.
  ...
  MakePerson("Max", "11-04-1987", "123-45-6789")
